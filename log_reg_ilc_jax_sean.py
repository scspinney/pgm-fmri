...
if __name__ == "__main__":
    ...
    for i in range(len(X_1)):          
        try:
            ...
            V1['X'][index-1] = np.load(X_1[i]).astype(np.float32)
        except:
        ...
        try:
            ...
            V1['y'][index-1] = np.load(y_1[i]).astype(np.float32)
        except:
    ...
    for i in range(len(X_3)):
        try:
            ...
            V3['X'][index-1] = np.load(X_3[i]).astype(np.float32)
        except:
        ...
        try:
            ...
            V3['y'][index-1] = np.load(y_3[i]).astype(np.float32)
        except:
